...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    updateThemeMainColor: (color) => {
      dispatch(
        optionsUpdateThemeMainColor(color || { r: 195, g: 147, b: 220, a: 1 })
      );
    },
    updateThemeSubColor: (color) => {
      dispatch(
        optionsUpdateThemeSubColor(color || { r: 195, g: 147, b: 220, a: 1 })
      );
    },
    toggleDisplay: (name) => {
...
class Options extends Component {
  ...
  getDisplayLabel(name, htmlId) {
    return (
      <label htmlFor={'display_' + (htmlId || name)} className='displayToggle'>
        {GL(name)}
      </label>
    );
  }
  ...
  getSwitch(name, key, name2, key2) {
    const appending = name2 ? (
      <div className='appending'>
        ...
        <input
          ...
          onChange={this.changeOption.bind(this, key2)}
        />
    ...
    return (
      <div className='line'>
        ...
        <label
          className='checkbox'
          onClick={this.toggleState.bind(this, key)}
        />
  ...
  render() {
    const themeMainColor = generateRGBAString(
      this.props.options.themeMainColor
    );
      ...
      <OptionsDiv themeMainColor={themeMainColor} themeSubColor={themeSubColor}>
        <section>
          ...
          <section>
            ...
            <div className='line'>
              ...
              <div
                className='left'
                id='themeMainColorPicker'
                onClick={this.updateColorPicker.bind(this, 'themeMainColor')}
              />
              {this.state.colorPicker == 'themeMainColor' ? (
                <div
                  ...
                  <SketchPicker
                    ...
                    onChangeComplete={this.setColor.bind(
                      this,
                      'themeMainColor'
                    )}
                  />
            ...
            <div className='line'>
              ...
              <div
                className='left'
                id='themeSubColorPicker'
                onClick={this.updateColorPicker.bind(this, 'themeSubColor')}
              />
        ...
        <section>
          ...
          <section>
            ...
            <div className='line'>
              <button onClick={this.emptyHistory.bind(this)}>
                {GL('empty_history')}
              </button>
            </div>
            <div className='line'>
              <button onClick={this.resetEverything.bind(this)}>
                {GL('reset_everything')}
              </button>
            </div>
          </section>
          <section>
            ...
            <input
              id='upload'
              type='file'
              onChange={this.importOptions.bind(this)}
            />
            <div className='line'>
              <button>
                <label htmlFor='upload'>{GL('import_options')}</label>
              </button>
            </div>
            <div className='line'>
              <button onClick={this.exportOptions.bind(this)}>
                {GL('export_options')}
              </button>
            </div>
          </section>
