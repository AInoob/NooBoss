      ...
      <ExtensionBriefDiv
        ...
        <div className='extensionBrief'>
          ...
          <div className='extensionInfo'>
            {extensionControl}
            <span id='extensionVersion'>{extension.version}</span>
            <br />
            <span id='extensionName' onClick={updateSubWindow}>
              {extension.name}
            </span>
          </div>
        </div>
