...
class NooBoss extends Component {
  constructor(props) {
    ...
    oldGet(
      'joinCommunity',
      (joinCommunity) => (shared.joinCommunity = joinCommunity)
    );
  ...
  render() {
    ...
    shared.themeMainColor = generateRGBAString(
...
export default connect(mapStateToProps, mapDispatchToProps)(NooBoss);
